                            ...
                            <div class="panel-content">
                                <div class="bg-warning-100 border border-warning rounded">
                                    ...
                                    <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                        ...
                                        <?php
                                        $arr=[Reports,Analytics,Export,Storage];
                                        foreach ($arr as $elem){
                                          echo '<li class="list-group-item"><span data-filter-tags="'. $elem .'">' . $elem . '</span></li>';
                                        };
                                        ?> -->
                                        <!-- Вариант 2 (списанный), но рабочий -->
                                        <?php
                                        $arr=[
                                          ["title" => "Reports",
                                          "tags" => "reports file"],
                                        ...
                                        foreach ($arr as $elem){
                                          // Вложенный массив $arr я бы вынес в начало документа.
                                          // Выводить элементы списка мне удобнее одной строкой.
                                          echo '<li class="list-group-item"><span data-filter-tags="'. $elem['tags'] .'">' . $elem['title']  . '</span></li>';
                                        };
                                        ?>
