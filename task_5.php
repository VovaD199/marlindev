                           ...
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            foreach ($people as $elem){
                              echo '<div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                      <img src="'. $elem['image'] .'" alt="'. $elem['image_alt'] .'" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                      <div class="ml-2 mr-3">
                                          <h5 class="m-0">'
                                              . $elem['name'] .'
                                          ...
                                          <a href="'. $elem['twiter_link_href'] .'" class="text-info fs-sm" target="_blank">'. $elem['twiter_link_text'] .'</a> -
                                          <a href="'. $elem['email_link_href'] .'" class="text-info fs-sm" target="_blank" title="'. $elem['email_link_title'] .'">'. $elem['email_link_text'] .'</a>
                                      </div>
                                  </div>';
